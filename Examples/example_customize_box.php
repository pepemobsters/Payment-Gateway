...
<html lang="en">
  ...
  <body>
	...
	<div class='card card-body bg-light d-inline-block'>
		...
		<h1 class="display-4">Customize GoUrl Bitcoin/ Altcoin Payment Box (2024 year)</h1>
...
&lt;?php
	...
	// List of coins that you accept for payments
	//$coins = array('bitcoin', 'bitcoincash', 'bitcoinsv', 'litecoin', 'dogecoin', 'dash', 'speedcoin', 'reddcoin', 'potcoin', 'feathercoin', 'vertcoin', 'peercoin', 'monetaryunit', 'universalcurrency');
	$coins = array('bitcoin', 'litecoin', 'dogecoin');  // for example, accept payments in bitcoin, bitcoincash, litecoin, dash, speedcoin 
